...
from course_discovery.apps.publisher_wordpress.dataloader.update_wordpress_course_runs import get_and_update_course_runs

logger = logging.getLogger(__name__)


class Command(BaseCommand):
    help = 'Update course-runs into publisher (Wordpress) app.'
